...
public class Timeline extends AbstractComponent implements LegacyComponent {
     ...
     */
    private class DirtyDataSourceListener implements Container.ItemSetChangeListener,
            Container.PropertySetChangeListener, Property.ValueChangeListener {
...
/*        for (Object entryObj : variables.entrySet()) {
    ...
    */
     ...
     * @deprecated Use {@link #addGraphDataSource(Container.Indexed, Object, Object)}
     *             instead
     */
    @Deprecated
    ...
    protected void removeGraphDataSource(int graphIndex) {
        ...
        // Remove listeners
        if (ds.getDatasource() instanceof Container.ItemSetChangeNotifier) {
            ((Container.ItemSetChangeNotifier) ds.getDatasource())
                    .removeListener(dataSourceListener);

        }
        if (ds.getDatasource() instanceof Container.PropertySetChangeNotifier) {
            ((Container.PropertySetChangeNotifier) ds.getDatasource())
                    .removeListener(dataSourceListener);
        }
        if (ds.getDatasource() instanceof Property.ValueChangeNotifier) {
            ((Property.ValueChangeNotifier) ds.getDatasource())
                    .removeListener(dataSourceListener);
        }
     ...
     * @deprecated Use
     *             {@link #setMarkerDataSource(Container.Indexed, Object, Object, Object)}
     *             instead
     */
    @Deprecated
     ...
     * @deprecated Use {@link #setEventDataSource(Container.Indexed, Object, Object)}
     *             instead
     */
    @Deprecated
    ...
    /**
     * @deprecated use {@link #setGraphCaption(Container.Indexed, String)} instead
     */
    @Deprecated
     ...
     *
     * Deprecated, use {@link #setGraphValuePropertyId(Container.Indexed, Object)}
     * instead.
     *
     * @param dataSource
     *            The data source of the graph
     ...
     * @deprecated Use {@link #setGraphCapsVisible(Container.Indexed, boolean)} instead
     */
    @Deprecated
     ...
     * @deprecated Use {@link #isGraphCapsVisible(Container.Indexed)} instead
     */
    @Deprecated
     ...
     *
     * @deprecated Use {@link #setGraphOutlineThickness(Container.Indexed, double)}
     *             instead
     */
    @Deprecated
     ...
     * @deprecated Use {@link #getGraphOutlineThickness(Container.Indexed)} instead.
     */
    @Deprecated
     ...
     */
    private int getContainerIndexForDate(Date date, Container.Indexed container,
    ...
    private void serializeDataPointsTostrings(Date start, Date end,
                                              int startIndex, int endIndex, int density, Container.Indexed cont,
    ...
    private void reduceModifiedRDP(int startIndex, int endIndex, int density,
                                   Container.Indexed cont, List<String> values, List<Item> items) {
    ...
    /**
     *
     * // @see http://en.wikipedia.org/wiki/Ramer–Douglas–Peucker_algorithm //TODO uncomment later
     *
     * @param points
     * @param epsilon
     * @param xyRatio
    ...
    private void listenToDatasourceChanges() {
        for (TimelineDatasourceProperties ds : datasources) {
            Container.Indexed dataSource = ds.getDatasource();
            ...
            if (dataSource instanceof Container.ItemSetChangeNotifier) {
                ...
                Container.ItemSetChangeNotifier isn = (Container.ItemSetChangeNotifier) dataSource;
            ...
            if (dataSource instanceof Container.PropertySetChangeNotifier) {
                ...
                Container.PropertySetChangeNotifier pscn = (Container.PropertySetChangeNotifier) dataSource;
            ...
            if (dataSource instanceof Property.ValueChangeNotifier) {
                ...
                Property.ValueChangeNotifier vcn = (Property.ValueChangeNotifier) dataSource;
        ...
        if (markers instanceof Container.ItemSetChangeNotifier) {
            getLogger().finest(
                    "Attaching ItemSetChangeListener to marker datasource");
            Container.ItemSetChangeNotifier isn = (Container.ItemSetChangeNotifier) markers;
        ...
        if (markers instanceof Container.PropertySetChangeNotifier) {
            getLogger().finest(
                    "Attaching PropertySetChangeListener to marker datasource");
            Container.PropertySetChangeNotifier pscn = (Container.PropertySetChangeNotifier) markers;
        ...
        if (markers instanceof Property.ValueChangeNotifier) {
            getLogger().finest(
                    "Attaching ValueChangeListener to marker datasource");
            Property.ValueChangeNotifier vcn = (Property.ValueChangeNotifier) markers;
        ...
        if (events instanceof Container.ItemSetChangeNotifier) {
            getLogger().finest(
                    "Attaching ValueChangeListener to marker datasource");
            Container.ItemSetChangeNotifier isn = (Container.ItemSetChangeNotifier) events;
        ...
        if (events instanceof Container.PropertySetChangeNotifier) {
            getLogger().finest(
                    "Attaching ValueChangeListener to marker datasource");
            Container.PropertySetChangeNotifier pscn = (Container.PropertySetChangeNotifier) events;
        ...
        if (events instanceof Property.ValueChangeNotifier) {
            getLogger().finest(
                    "Attaching ValueChangeListener to marker datasource");
            Property.ValueChangeNotifier vcn = (Property.ValueChangeNotifier) events;
    ...
    public List<Container.Indexed> getGraphDatasources() {
        List<Container.Indexed> graphs = new ArrayList<Container.Indexed>();
