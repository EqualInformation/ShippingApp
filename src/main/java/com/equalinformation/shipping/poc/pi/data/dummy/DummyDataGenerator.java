...
public abstract class DummyDataGenerator {
    ...
    static String randomFirstName() {
        String[] names = { "Ram", "Ravan", "Laxman", "Bharat", "Ravi" };
        return names[(int) (Math.random() * names.length)];
    }

    static String randomLastName() {
        String[] names = { "Upadhyaya", "Poudel", "Shrestha", "Gautam", "Pokharel" };
        return names[(int) (Math.random() * names.length)];
    }
    ...
    static Collection<ShippingNotification> randomNotifications() {
        ShippingNotification n1 = new ShippingNotification();
        n1.setId(1);
        ...
        ShippingNotification n2 = new ShippingNotification();
        n2.setId(2);
