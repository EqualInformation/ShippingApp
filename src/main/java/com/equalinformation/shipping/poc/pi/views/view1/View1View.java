...
import com.equalinformation.shipping.poc.pi.components.SparklineChart;
import com.equalinformation.shipping.poc.pi.data.dummy.DummyDataGenerator;
...
public class View1View extends Panel implements View, View1Edit.ShippingEditListener {
    ...
    private Component buildEditButton() {
        ...
        result.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(final Button.ClickEvent event) {
                getUI().addWindow(
                        new View1Edit(View1View.this, titleLabel
                                .getValue()));
            }
        });
        return result;
...
/*    private Component buildPopularMovies() {
    ...
    private void openNotificationsPopup(final Button.ClickEvent event) {
        ...
        Collection<ShippingNotification> notifications = ShippingUI
                .getDataProvider().getNotifications();
        ShippingEventBus.post(new ShippingEvent.NotificationsCountUpdatedEvent());
    ...
    public static final class NotificationsButton extends Button {
        ...
        public void updateNotificationsCount(
            ...
            setUnreadCount(ShippingUI.getDataProvider()
